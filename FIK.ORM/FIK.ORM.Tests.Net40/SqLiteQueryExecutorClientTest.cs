    ...
    public class SqLiteQueryExecutorClientTest
    {
        ...
        public void ShouldInsertOrUpdateRecordInSchema_WhenNoTableNameProvidedAndSchemaProvided()
        {
            ...
            try
            {
                ...
                Assert.That(actualIvnItem[0].Quantity, Is.EqualTo(inventoryTestDatas[0].Quantity + 110.5m));
                Assert.That(actualIvnItem[0].ItemId, Is.EqualTo(inventoryTestDatas[0].ItemId));
                Assert.That(actualIvnItem[1].Quantity, Is.EqualTo(inventoryTestDatas[1].Quantity ));

    ...
    public class SqlQueryExecutorClientTest
    {
        ...
        public void ShouldInsertSingleBlobData()
        {
            ...
            try
            {
                ...
                //Act
                queryExecutorClient.Insert(itemsTestData, null, "ItemBlob", "dbo");
                queryExecutorClient.CommitTransaction();
                var actualItem = queryExecutorClient.Select<ItemBlob>(typeof(ItemBlob), null, whereColumns, null, null, "ItemBlob", "dbo").SingleOrDefault();

                //Assert
                Assert.That(actualItem, Is.Not.Null);
                Assert.That(actualItem.Id, Is.EqualTo(itemsTestData.Id));
                Assert.That(actualItem.BlobData, Is.EqualTo(itemsTestData.BlobData) );
            }
            catch (Exception)
            {
                throw;
            ...
            {
                queryExecutorClient.Delete<ItemBlob>(itemsTestData, new string[] { "Id" }, "ItemBlob", "dbo");
                queryExecutorClient.CommitTransaction();
            }
        }
        ...
        public void ShouldInsertSingleRecordInSchema_WhenNoTableNameProvidedAndSchemaProvided()
        {
            ...
            try
            {
                ...
                queryExecutorClient.Insert<Items>(itemsTestData, null, "Item", "dbo");
                queryExecutorClient.CommitTransaction();
        ...
        public void ShouldInsertMultipleRecordInSchema_WhenNoTableNameProvidedAndSchemaProvided()
        {
            ...
            try
            {
                ...
                var actualItem = queryExecutorClient.Select<Items>(typeof(Inventory), null, whereClauseItem, null, null, "Item").Count();
        ...
        public void ShouldProcessCompositeModelInSchema()
        {
            ...
            try
            {
                ...
                itemsTestData.Price = 15.5m;
                compositeModelBuilder.AddUpdateRecordSet<Items>(itemsTestData, new string[] { "Id" }, new string[] { "Price" }, "Item", "dbo");

                compositeModelBuilder.AddRecordSetRawQuery("UPDATE dbo.Item Set price=16 WHERE Id=11 ");

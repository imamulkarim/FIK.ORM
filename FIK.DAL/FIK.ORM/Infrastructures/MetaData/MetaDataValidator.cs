...
namespace FIK.ORM.Infrastructures.MetaData
{
    internal class MetaDataValidator
    {
        ...
        public MetaDataInfo[] GetValidColumns(string schemaName, string tableName, IEnumerable<string>? columns, bool withIdentityColumn)
        {
        ...
        private Dictionary<string, string> ExtractColumnModifier(IEnumerable<string>? columns)
        {
            if(columns == null || !columns.Any())
            {
                return null!;
